...
do
    ...
    do
        ...
        -o ${baseFOLDER}/intermediate_files/${SAMPLE_ID}_${TRIM}_mapped.sorted
        ...
        java -jar ~/miniconda3/envs/snpeff_only/share/snpeff-5.2-1/snpEff.jar \
        NG19424 \
        ${baseFOLDER}/rawpileup_files/${SAMPLE_ID}_${TRIM}.rawpileup > ${baseFOLDER}/annotated_files/${SAMPLE_ID}_${TRIM}.ann.vcf
